...
export default function Science() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-sky-100 to-blue-100 flex items-center justify-center">
      {/* ✅ Watermark logo */}
      <div className="absolute bottom-13 right-5 flex flex-col items-center opacity-40 pointer-events-none">
    <img 
      src="/logo.png" 
      alt="App Logo Watermark"
      className="w-12 mb-1"  // smaller size
    />
    <span className="text-sm font-bold text-gray-800">Eklavya</span>
  </div>
      <div className="text-center p-8 bg-white rounded-2xl shadow-lg max-w-lg mx-4">
        ...
        <div className="space-y-4">
          ...
          >
            <span>
              {" "}
              <img className="h-10" src={"/chef.gif"} />{" "}
            </span>
            <span>Chef Game</span>
          </Link>
          ...
          >
            <span>
              {" "}
              <img className="h-10" src={"/hotsummer.gif"} />{" "}
            </span>
            <span>Solar Game</span>
          </Link>
          ...
          >
            <span>
              {" "}
              <img className="h-9" src={"/temp.gif"} />{" "}
            </span>
          ...
          >
            <span>
              {" "}
              <img className="h-10" src={"/lens.gif"} />{" "}
            </span>
            <span>Material Mix Up</span>
          </Link>
          ...
          >
            <span>
              {" "}
              <img className="h-10" src={"/drop.gif"} />{" "}
            </span>
            <span>Water Cycle Adventure</span>
          </Link>
        </div>
